...
export default function Home() {
  return  <Flex className={cn("container flex-col justify-between h-full")}>
    <div className=" pt-[6vh]">
      <Image src="/images/logo.svg" className="aspect-[51/71] w-[51px]" />
      ...
      <Typography className="mt-6 text-[0.875rem] leading-[1.375rem] font-medium text-black/60">Pre-register now to get your first-come-first-served bonus, and share your referral code with your friends now.</Typography>
    </div>
